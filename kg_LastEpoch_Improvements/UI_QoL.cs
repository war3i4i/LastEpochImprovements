...
public static class UI_QoL
{
    ...
    private static class EnableWovenEchoesTabIfRelevant_Awake_Patch
    {
        ...
        private const string keys_base64 = "";
        ...
        private static void Postfix(EnableWovenEchoesTabIfRelevant __instance)
        {
            ...
            CreateButton(copy, "Keys", keys_base64.ToSprite(), Color.magenta, () => 
            {
                if (UIBase.instance.dungeonKeysTraderPanel.instance && UIBase.instance.dungeonKeysTraderPanel.instance.active) UIBase.instance.closeDungeonKeysTraderPanel();
                else UIBase.instance.openDungeonKeysTraderPanel();
            });
        }
    }
}
